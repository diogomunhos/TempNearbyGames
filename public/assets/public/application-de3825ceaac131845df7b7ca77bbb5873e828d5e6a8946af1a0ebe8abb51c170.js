...
angular.module('public-module', [
	...
	'public-module.platform-services',
...
.controller('all-articles-controller', ['articleServices', '$scope', '$timeout', '$window', function(articleServices, $scope, $timeout, $window) {
	...
	$scope.getArticles();
	$scope.showSideBar = ($scope.mobilecheck() === true) ? false : true;
...
var _datMenuHeaderTitle = (typeof _datMenuHeaderTitle === "undefined") ? '<a href="#"><img src="/assets/new-template/images/logo.png" style="background-color: #0589cd;" alt="" /></a>' :_datMenuHeaderTitle;		// Header Title
...
(function() {
  jQuery(function() {
    ...
    return window.fbAsyncInit = function() {
      FB.init({
        appId: '1735599803381451',
        cookie: true
      });
      return $('#signin_facebook').click(function(e) {
        console.log('click');
        e.preventDefault();
        return FB.login(function(response) {
          ...
          return $('#signout_facebook').click(function(e) {
...
angular.module('public-module.platform-controller', [])
.controller('platform-all-articles-controller', ['platformServices', '$scope', '$timeout', '$window', function(platformServices, $scope, $timeout, $window) {
